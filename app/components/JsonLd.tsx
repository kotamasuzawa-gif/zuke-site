...
const products = [
  ...
  { name: 'PLANTS POLE 六角鉢セット "3つの六角形"', price: 1980, url: "https://www.zukeplants.com/products/hexpot-set", image: "https://www.zukeplants.com/products/product-hexpot-set-black.webp", description: "六角形の鉢・受け皿・支柱の3点セット。PLA樹脂・3Dプリント製" },
