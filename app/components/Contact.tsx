export default function Contact() {
  return (
    <section id="contact" className="bg-[#111111]">
      <div className="max-w-7xl mx-auto px-8 py-32 grid md:grid-cols-2 gap-16 items-end">

        {/* 左：テキスト */}
        <div>
          <p className="text-[10px] tracking-[0.5em] text-gray-500 mb-16 font-light">CONTACT</p>
