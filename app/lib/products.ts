...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    baseUrl: SHOP,
    summary:
      "六角鉢と同じ六角形のフォルムの花瓶。高さ約16cm、口に向かって少しすぼまる形。PLA樹脂・3Dプリント製、ホワイト。排水穴なしで水漏れしません。",
    lead:
      "六角鉢シリーズと並べて使える花瓶。底の対辺約55mmから口の対辺約47mmへ、上に向かって少しすぼまるので、一輪でも枝ものでも収まりがよい形です。角を丸めたやさしい輪郭で、マットな白の質感。",
    height: "約160mm",
